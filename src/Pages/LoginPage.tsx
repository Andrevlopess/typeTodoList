...
import { Button, Center, Container, Flex, Heading, Image, Input, Text } from '@chakra-ui/react';
            ...
            <Flex w='100%'>
                <Flex flexDirection='column' >
                    <Flex flexDirection='column' px='80px'>
                        <Heading fontSize='100px' color='txtY' fontWeight='800' mb='60px'>Sign in</Heading>
                        <Text fontSize='30px' color='txtColor' fontWeight='800' mb='80px'>Login to access your tasks</Text>
                    </Flex>

                    <SimpleYList />
                </Flex>
                <Flex flexDirection='column' bgColor='compBg' borderRadius='25px' p='60px' ml='200px' maxH='480px'>
